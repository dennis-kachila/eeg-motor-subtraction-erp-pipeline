%% ========================================================================
%% RUN STEP 5: POST-ICA PROCESSING FOR ALL SUBJECTS
%% ========================================================================
% This script runs Step 5 (post-ICA processing) for all subjects
%
% IC-rejected data must already exist in derivatives/eeglab_IC_rejection/ (Step 4)
% Output is saved to derivatives/eeglab_post_ICA/
%
% Performs: channel interpolation, epoch rejection, final re-reference
%% ========================================================================
...
%% Run Step 5: Post-ICA Processing
fprintf('=== RUNNING STEP 5: POST-ICA PROCESSING ===\n');
fprintf('This will process both task-action and task-no-action files\n');
fprintf('Input:  derivatives/eeglab_IC_rejection/\n');
fprintf('Output: derivatives/eeglab_post_ICA/\n\n');

RunMyScripts('Subs', subjects, 'Script', 'PrepareData', 'Function', 5, 'Pipeline', pipeline);