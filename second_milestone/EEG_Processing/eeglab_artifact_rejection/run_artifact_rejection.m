%% ========================================================================
%% RUN STEP 2: AUTOMATED ARTIFACT REJECTION FOR ALL SUBJECTS
%% ========================================================================
% This script runs Step 2 (automated artifact rejection) for all subjects
%
% This will process all subjects in your derivatives/eeglab_preproc folder
% and save cleaned data to derivatives/eeglab_artifact_rejection/
%
...
%% Run Step 2: Automated Artifact Rejection
fprintf('=== RUNNING STEP 2: AUTOMATED ARTIFACT REJECTION ===\n');
fprintf('This will process both task-action and task-no-action files\n');
fprintf('Input:  derivatives/eeglab_preproc/\n');
fprintf('Output: derivatives/eeglab_artifact_rejection/\n\n');

RunMyScripts('Subs', subjects, 'Script', 'PrepareData', 'Function', 2, 'Pipeline', pipeline);
